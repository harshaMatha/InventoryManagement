...
<div style="margin-left:70px; margin-top:40px">
   ...
   <form onsubmit="return validateForm()" >
    ...
    <button type="button" style="margin-left: 120px;  background-color: #4CAF50; color:white; border: none; border-radius: 5px; width: 120px; height: 40px;" onclick="addProduct()">Add</button>
  </div>
  ...
  <button type="button" style="margin-left: 120px;  background-color: #4CAF50; color:white; border: none; border-radius: 5px; width: 120px; height: 40px;">Update Stock</button>
</form>
   </div> 
